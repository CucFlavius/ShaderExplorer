    ...
    class p {
        ...
        _createSortedPathsRules() {
            this.sortedPathsRules = [], u.Utilities.forEachProperty(this.options.paths, (r, c) => {
                Array.isArray(c) ? this.sortedPathsRules.push({from: r, to: c}) : this.sortedPathsRules.push({
                    from: r,
                    to: [c]
                })
        ...
        load(e, i, s, n) {
            if (/^node\|/.test(i)) {
                let l = e.getConfig().getOptionsLiteral(),
                    d = c(e.getRecorder(), l.nodeRequire || u.global.nodeRequire), o = i.split("|"), _ = null;
                try {
                    _ = d(o[1])
                } catch (f) {
                    n(f);
        ...
        load(e, i, s, n) {
            if (/^node\|/.test(i)) {
                const l = e.getConfig().getOptionsLiteral(),
                    d = c(e.getRecorder(), l.nodeRequire || u.global.nodeRequire), o = i.split("|");
                let _ = null;
                try {
                    _ = d(o[1])
                } catch (f) {
    ...
    class r {
        ...
        load(e, i, s, n) {
            ...
            if (/^node\|/.test(i)) {
                ...
                const f = this._path.normalize(i), g = this._getElectronRendererScriptPathOrUri(f),
                    v = !!l.nodeCachedData, E = v ? this._getCachedDataPath(l.nodeCachedData, i) : void 0;
...
(function (u) {
    ...
    class c {
        ...
        _loadModule(t) {
            ...
            let e = this._moduleIdProvider.getStrModuleId(t), i = this._config.moduleIdToPaths(e),
                s = /^@[^\/]+\/[^\/]+$/;
